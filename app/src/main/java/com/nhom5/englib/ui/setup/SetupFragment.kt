...
import com.nhom5.englib.databinding.FragmentSetupBinding
...
class SetupFragment:Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.sWaitTime.setValue(10.0F)
        binding.sNumQuest.setValue(30.0F)
        ...
        binding.apply {
            ...
            btnDefault.setOnClickListener{
                ...
                if (defaultWaitTime != null) {
                    sWaitTime.setValue(defaultWaitTime.toFloat())
                }
                if (defaultNumQuest != null) {
                    sNumQuest.setValue(defaultNumQuest.toFloat())
                }
